...
# Cocotb examples are optional for this focused submission. Keep the standard
# Caravel targets usable when the optional template directory is absent.
ifeq ($(wildcard verilog/dv/cocotb),)
cocotb-dv_patterns=
else
